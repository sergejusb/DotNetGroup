...
namespace Tests.Api
{
    ...
    public class RoutingTests
    {
        ...
        [Test]
        public void Given_Path_Is_Rss_Json_Url_Then_RssControler_Json_Action_With_Id_Parameters_Is_Called()
        {
            var routes = new RouteCollection();
            MvcApplication.RegisterRoutes(routes);
        ...
        [Test]
        public void Given_Path_Is_Twitter_Json_Url_Then_TwitterControler_Json_Action_With_Id_Parameters_Is_Called()
        {
            var routes = new RouteCollection();
            MvcApplication.RegisterRoutes(routes);
